                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{ route('admin.generateQuestion.create', $question->exam_id) }}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Generate">
                                                        Generate
                                                    </a> ||
                                                    <a href="{{ route('admin.generateQuestion.show', $question->exam_id) }}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Question">
                                                        Edit Question
                                                    </a>

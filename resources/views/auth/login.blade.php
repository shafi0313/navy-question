...
<body >
    <div class="row no-gutters">
        <div class="col-md-8" style="background: url('{{ asset('uploads/images/54567.jpg') }}');background-size: cover;background-repeat: no-repeat;">
            {{-- <img src="{{ asset('uploads/images/54567.jpg') }}" alt=""> --}}
        </div>
        <div class="col-md-4">
            <div class="login">
                <div class="wrapper wrapper-login">
                    <div class="container container-login animated fadeIn">
                        <h2 class="text-center" style="font-family: 'Marcellus SC', serif; font-weight: bold; font-size: 23px;">Bangladesh Navy Question Bank</h2>
